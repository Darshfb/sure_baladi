                ...
                itemBuilder: (context, index) => Column(
                  children: [
                    ListTile(
                      ...
                      dense: true,
                      title: Text(
                          '${cubit.allCategoriesModel!.content[index].categoryName}', style: Theme.of(context).textTheme.bodyText1),
                      leading: const Icon(IconBroken.buy, color: Colors.deepOrange,),
